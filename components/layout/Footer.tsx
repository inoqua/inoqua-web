      ...
      <div className="mx-auto max-w-content px-6 pt-12 pb-4 sm:px-10 lg:px-20">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1fr_1fr_auto]">
          ...
          <div>
            ...
            <ul className="mt-4 flex flex-col gap-3 lg:pr-12">
              {serviciosLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-[15px] text-white/90 transition-colors hover:text-naranja"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="mt-4 flex flex-col gap-4">
              <li className="flex items-center gap-3">
                ...
                <a href={contactInfo.phoneHref} className="text-[15px] text-white/90 hover:text-naranja">
                  {contactInfo.phone}
                </a>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div className="flex flex-col gap-1">
                  <a href={`mailto:${contactInfo.email}`} className="text-[15px] text-white/90 hover:text-naranja">
                    {contactInfo.email}
                  </a>
                  <a href={`mailto:${contactInfo.email2}`} className="text-[15px] text-white/90 hover:text-naranja">
                    {contactInfo.email2}
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[15px] text-white/90 hover:text-naranja"
                >
