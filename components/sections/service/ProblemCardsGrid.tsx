      ...
      <div className="mt-4 grid grid-cols-2 gap-4 sm:grid-cols-3">
        {cards.map((card, i) => (
          <Reveal key={card.text} delay={i * 80}>
            <div className="flex h-30 items-center gap-3 rounded-card bg-azul px-3 py-4 text-left transition-transform duration-300 hover:-translate-y-1 md:gap-5 md:px-8">
